  ...
  Form buildForm() {
    return Form(
          ...
          child: Column(
            children: [
              Spacer(),
              Text("Sign up" , style: TextStyle(fontFamily: 'Montserrat', fontSize: 40),textAlign: TextAlign.center,),
              Spacer(),
              Stack(
                children: [
                  CircleAvatar(
              ...
              Row(
                ...
                children: [
                  ...
                  new DropdownButton<String>(
                    ...
                    onChanged: (value) {_branch=value;setState(() {FocusScope.of(context).requestFocus(FocusNode());super.setState(() {});});},
                    hint: Text('branch'),
                  ),]
                  ),
                  Row(
                    ...
                    items: <String>['First Year','Second Year','Third Year','Fourth Year'].map((String value) {
                      return new DropdownMenuItem<String>(
                       ...
                       onChanged: (value) {
                         ...
                         _year=value;
                         setState(() {FocusScope.of(context).requestFocus(FocusNode());super.setState(() {});});},
                       hint: Text('Year'),
                  ),]
                  )
                ],
